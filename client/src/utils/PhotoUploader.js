...
<div>
                            ...
                            <button onClick={addPhotoByLink}  disabled={!photoLink.trim()} className={` mt-4 px-4 py-2 ml-2 bg-primary rounded-2xl hover:translate-x-1.5 duration-500 hover:scale-95 hover:bg-three hover:text-primary transition-opacity ${
                                    !photoLink.trim() ? 'opacity-50 cursor-not-allowed' : ''
                                }`}>Add photo</button>
                        </div>
